...
$('.waifu-tool .fui-info-circle').click(function (){
    window.open('https://blog.hdqyf.club/about/');
});
...
$('.article-title').click(function () {//标题被点击时
	...
	$('.page-number').mouseover(function(){
        showMessage('想去第'+ $(this).text() + '页看看吗?');
    });
    $('.article-nav-title').mouseover(function () {
        showMessage('去 <span style="color:#0099cc;">' + $(this).text() + '</span> 逛逛');
    });
	$('#rewardBtn').mouseover(function(){
        showMessage('主人为了敲代码已经几天没吃饭了，你就赏一个嘛~');
    });
	$('#share-sub').mouseover(function () {
        showMessage('在这里可以把主人的宝贝分享给亲朋好友!');
    });
    $('.site-title').mouseover(function () {
        showMessage('点它就可以回到首页啦！');
    });
    $('.share-sns').mouseover(function () {
        showMessage('你知道吗?点它可以分享本文到'+$(this).attr('data-title'));
    });
    $('.article-more-link').mouseover(function () {
        showMessage('这里查看这个文章的更多内容!');
    });
...
function loadModel(modelId, modelTexturesId){
    ...
    loadlive2d('live2d', 'https://api.hdqyf.club/live2d/get/?id='+modelId+'-'+modelTexturesId);
}
...
function loadRandModel(){
    ...
    $.ajax({
        cache: false,
        url: 'https://api.hdqyf.club/live2d/'+modelTexturesRandMode+'_textures/?id='+modelId+'-'+modelTexturesId,
        dataType: "json",
        success: function (result){
...
function loadOtherModel(){
    ...
    $.ajax({
        cache: false,
        url: 'https://api.hdqyf.club/live2d/'+modelTexturesRandMode+'/?id='+modelId,
        dataType: "json",
        success: function (result){
